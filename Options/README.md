...
- `Window.lua` hosts those LibSharedCanvas panels in BCDM's draggable and resizable settings window, including the sidebar Changelog page (mirroring `CHANGELOG.md`) and persisted opacity control.
