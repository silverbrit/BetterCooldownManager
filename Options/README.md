...
- `Trinkets.lua` owns equipped-slot selection, shared trinket behavior, and focused per-slot overrides. New defaults show all equipped trinkets and center the bar on Blizzard's UIParent unless ElvUI or EllesmereUI Unit Frames provides a player-frame anchor.
